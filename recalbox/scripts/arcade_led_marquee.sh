...
# ArcadeLedMarquee integration for Recalbox EmulationStation events.
# Copy this file to /recalbox/share/userscripts and edit IP_ESP32.

SCRIPT_VERSION="arcade_led_marquee.sh:v1.0.0"

# IP address of your ESP32 running ArcadeLedMarquee.
...
# IP_ESP32="192.168.1.108"
# CURL_TIMEOUT="8"
CONFIG_FILE="/recalbox/share/system/configs/arcade_led_marquee.conf"
...
log() {
  logger -t arcade-led-marquee "$SCRIPT_VERSION $1" 2>/dev/null || true
}
...
# used by the ArcadeLedMarquee GIF folder, for example snes or neogeo.
