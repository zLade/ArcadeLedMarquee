...
// ====================================================================
//                  ArcadeLedMarquee - Recalbox dedicated build
// ====================================================================
...
// HUB75 pinout kept from the tested DMD/HUB75 hardware profile.
#define CLK_PIN       16
#define OE_PIN        15
#define LAT_PIN       4
#define A_PIN         33
...
struct AppConfig {
  String ssid = "";
  String password = "";
  String hostname = "arcade-led-marquee";
  bool dhcp = true;
...
void setup() {
  Serial.begin(115200);
  Serial.println();
  Serial.println("ArcadeLedMarquee Recalbox firmware " FIRMWARE_VERSION);
